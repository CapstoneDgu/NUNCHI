...
| 임현우 | <img src="https://github.com/user-attachments/assets/38a337c7-6881-4e92-a918-a740acc21b20" alt="임현우" width="100"> | <ul><li>기획 및 디자인 시스템 구축</li><li>AI 아바타 제작 및 동작 구현</li><li>프론트 통합 및 아바타 주문 플로우 구현</li><li>SSE 클라이언트 구축</li></ul> |
