...
| 이현노 | <img src="https://github.com/leehyunro123.png" alt="현노" width="100"> | <ul><li>일반 모드 키오스크 UI 및 음성 주문 플로우 개발 (STT 연동, 메뉴 탐색부터 담기까지 화면 자동 제어)</li><li>AI 추천 모달 및 눈치(망설임) 추천 모달 프론트 구현</li><li>결제 플로우 전 화면 구현 및 백엔드·장바구니 서버 연동</li><li>실 카드 단말기 하드웨어 연동, 영수증·번호표 출력 연결</li><li>저자세(배리어프리) 모드 구현</li></ul> |
